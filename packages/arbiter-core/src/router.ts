...
export interface ArbiterRouterOptions {
  cloud?: CloudModelCatalog;
}

/**
 * ArbiterRouter (Constitutional Constraint 2): the only component authorised to
 ...
 */
export function createArbiterRouter(opts: ArbiterRouterOptions = {}): IArbiterRouter {
...
function route(
  { signals, capability }: ArbiterRouterInputs,
  cloud: CloudModelCatalog,
): RoutingDecision {
