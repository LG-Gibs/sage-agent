...
import type { IArbiterRouter } from '../router';
...
export interface BenchmarkResult {
  ...
  agreements: number;
  rate: number;
  disagreements: Array<{ signals: ArbiterSignals; expected: RoutingTarget; got: RoutingTarget }>;
}

/** Runs the router across the benchmark and reports agreement on target. */
export async function runRoutingBenchmark(router: IArbiterRouter): Promise<BenchmarkResult> {
