...
import type { ArbiterSignals, CapabilityManifest, ToolCall, ToolName, ToolDomain } from '@sage/shared-types';
import {
  ReActLoop,
  ReActError,
  ToolDomainRouter,
...
const arbiter = createArbiterRouter();
...
function buildLoop(cloudCycles: InferenceEvent[][], opts: { localCycles?: InferenceEvent[][]; signals?: ArbiterSignals; maxIterations?: number; hooks?: ConstructorParameters<typeof ReActLoop>[0]['hooks'] } = {}) {
