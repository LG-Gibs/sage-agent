...
import { decodeSseStream, type SageStreamEvent } from '@sage/sse-contract';
...
async function postInfer(
  body: unknown,
): Promise<{ status: number; contentType: string; events: SageStreamEvent[]; json?: unknown }> {
